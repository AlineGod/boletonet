    ...
    public class BoletoBancario : System.Web.UI.Control
    {
        ...
        public string GeraHtmlReciboCedente()
        {
            try
            {
                ...
                //Para carteiras "17-043", "17-019" e "18-019" do Banco do Brasil, a ficha de compensação não possui código da carteira
                //na formatação do campo.
                if (Boleto.Banco.Codigo == 1 & (Boleto.Carteira.Equals("17-043") | Boleto.Carteira.Equals("17-019") | Boleto.Carteira.Equals("17-027") | Boleto.Carteira.Equals("18-019") | Boleto.Carteira.Equals("17-159") | Boleto.Carteira.Equals("17-140") | Boleto.Carteira.Equals("17-067")))
                {
        ...
        private string MontaHtml(string urlImagemLogo, string urlImagemBarra, string imagemCodigoBarras)
        {
            ...
            #region Implementação para o Banco do Brasil
                //Variável inserida para atender às especificações das carteiras "17-043", "17-019", "17-027" e "18-019" do Banco do Brasil
                //apenas para a ficha de compensação.
                //Como a variável não existirá se não forem as carteiras "17-043", "17-019", "17-027", "17-035", "17-140", "17-159", "17-067", "17-167" e "18-019", não foi colocado o [if].
                .Replace("@NOSSONUMEROBB", Boleto.Banco.Codigo == 1 & (Boleto.Carteira.Equals("17-043") | Boleto.Carteira.Equals("17-019") | Boleto.Carteira.Equals("17-027") | Boleto.Carteira.Equals("17-035") | Boleto.Carteira.Equals("18-019") | Boleto.Carteira.Equals("17-140") | Boleto.Carteira.Equals("17-159") | Boleto.Carteira.Equals("17-067") | Boleto.Carteira.Equals("17-167")) ? Boleto.NossoNumero.Substring(3) : string.Empty)
